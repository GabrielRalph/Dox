...
import {getRichText} from './RichText.js'
...
class DoxTextNode extends DoxNode {
  constructor(props){
    super();
    this.addClassCat("dox-text", "nodes");
...
class Section extends DoxContainer {
  constructor() {
    super();
    this.addClassCat("section", "nodes");
  }
}
...
class RichText extends DoxTextNode {
  constructor(){
    super();
    this.addClassCat("rich-text", "nodes");
  }
}
